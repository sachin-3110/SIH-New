  ...
  return (
    ...
    <div className="w-full h-screen flex justify-center items-center bg-gray-200">
      ...
      <section className="container mx-auto px-5">
        ...
        <form id="contactForm" className="max-w-lg mx-auto bg-white p-8 rounded shadow" onSubmit={handleSubmit}>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              placeholder="somethin@something.com"
              name="email"
              className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
              required
            />
          ...
          <div className="mb-4">
            ...
            <textarea
              id="message"
              name="message"
              placeholder="write your situtation briefly"
              rows="4"
              className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
              required
            ></textarea>
        ...
        {/* Success Message */}
        <p id="successMessage" className="text-center text-green-500 text-lg mt-6 hidden">
