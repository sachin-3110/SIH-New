...
function Home() {
    ...
    return (
        <div className='w-full min-h-screen'>
            <section className="bg-fixed bg-[url('https://images.pexels.com/photos/1739855/pexels-photo-1739855.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-cover bg-center h-auto w-full">
                <div className="flex bg-black bg-opacity-30 lg:h-screen items-center flex-col md:flex-row w-full md:mx-auto p-4 pt-14 md:p-6 lg:pt-20">
                    ...
                    <div className="w-full md:w-1/3 flex my-5 flex-col h-auto justify-center items-center md:pl-10 gap-2 text-xl md:gap-5 md:text-[2.5vh]">
                        <div className="flex flex-wrap flex-row gap-2 md:gap-5 text-[1.5vh] md:text-[2.5vh]">
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">SOS-Ambulance</button>
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">SOS First-Aid</button>
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">First-Aid Steps</button>
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">Precautionary Steps</button>
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">Health Care Centers</button>
                            <button onClick={handleAlertButtonClick} className="md:py-1 md:px-2 px-1 bg-orange-500 shadow-[0_5px_20px_rgba(255,255,255)] rounded-2xl text-white font-semibold hover:border-[1px] hover:text-white duration-300 hover:bg-transparent">Relief Camps</button>
                        </div>
                    </div>
                    {/* Alert buttons Home Page END */}
                </div>
            </section>
            <section className="container mx-auto my-10 gap-2 h-auto md:flex-row flex-col-reverse md:h-[70vh] flex p-4">
                <div className="w-full border-2 rounded-xl overflow-hidden md:w-1/2 mx-2 h-full">
                ...
                <div className="w-full flex md:flex-col justify-between items-center md:w-1/2 mx-2 h-full text-center text-black text-3xl md:text-5xl lg:text-[10vh] tracking-wider">
                    <p className=''>Nearby Situation</p>
                    <div className=" flex justify-center items-center">
                      {/* add a news api */}
                        <button className="text-lg md:text-2xl hover:bg-transparent hover:border-black border-[1px] duration-300 hover:border-[1px] hover:text-black md:my-4 bg-black text-white py-2 px-3 w-fit rounded-full">click</button>
                    </div>
                </div>
            </section>
                ...
                <div className="flex flex-wrap justify-center -mx-4">
                    <div className="w-full md:w-1/3 xl:w-1/3 p-4">
                        ...
                        <div className="bg-white rounded shadow-[5px_5px_0px_0px_rgba(249,115,22)] p-4">
                            ...
                            <a href="predisaster.html" className="bg-orange-500 duration-500 hover:text-orange-500 hover:bg-white hover:border-b-2 hover:border-l-4 text-white font-bold py-2 px-4 rounded text-center block">GuideLines</a>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 xl:w-1/3 p-4">
                        <div className="bg-white rounded shadow-[5px_5px_0px_0px_rgba(249,115,22)] p-4">
                            ...
                            <a href="duringdisaster.html" className="bg-orange-500 duration-500 hover:text-orange-500 hover:bg-white hover:border-b-2 hover:border-l-4 text-white font-bold py-2 px-4 rounded text-center block">GuideLines</a>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 xl:w-1/3 p-4">
                        <div className="bg-white rounded shadow-[5px_5px_0px_0px_rgba(249,115,22)] p-4">
                            ...
                            <a href="afterdisaster.html" className="bg-orange-500 text-white font-bold py-2 px-4 rounded text-center duration-500 hover:text-orange-500 hover:bg-white hover:border-b-2 hover:border-l-4 block">GuideLines</a>
                        </div>
                    </div>
                </div>
            </main>
