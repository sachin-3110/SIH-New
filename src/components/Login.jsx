...
const AdminLogin = () => {
  ...
  return (
      <div className="h-screen mx-auto flex justify-center items-center p-4 pt-6 md:p-6 lg:p-12 bg-black">
      <div className="flex justify-center items-center">
        <div className="w-full max-w-md">
          <h2 className="text-3xl font-bold text-white">Admin Login</h2>
          <p className="text-lg text-gray-200">Please enter your admin credentials to log in.</p>
